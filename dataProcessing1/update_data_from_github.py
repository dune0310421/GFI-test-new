...
def update_dataset_file(gh, filepth: str, token: str):
...
if __name__ == "__main__":
    ...
    token = "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"
    gh = Github(token)
    # update_dataset(gh, filepth="../data/pandas_gfi_pr.json", token=token)
    update_data(gh, {"owner":"pandas-dev","name":"pandas"})